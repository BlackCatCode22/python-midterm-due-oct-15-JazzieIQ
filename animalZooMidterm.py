...
### Try block for read-in documents and initial formatting for gen_habitat and animal_names
    ...
    try:
        with open(r"C:\Users\Matthew\Desktop\School Docs\CIT Projects\CIT 95\python-midterm-due-oct-15-JazzieIQ\animalNames.txt", "r") as animal_names_file:
            names = animal_names_file.read()
            names = names.replace("Names:\n", "Habitat: ").replace("Ryker\n", "Ryker")
            print(names + "\n")

        with open(r"C:\Users\Matthew\Desktop\School Docs\CIT Projects\CIT 95\python-midterm-due-oct-15-JazzieIQ\arrivingAnimals.txt", "r") as arriving_animals_file:
